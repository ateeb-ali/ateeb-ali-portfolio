...
├── styles.css      # Styling
├── data.js         # All content — experience, projects, skills, certs, etc.
├── script.js       # Renders data.js into the page + interactivity
└── assets/
...
- Linktree: [linktr.ee/ateebali](https://linktr.ee/ateebali))
